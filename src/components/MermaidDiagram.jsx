...
const MermaidDiagram = ({ chart, id = 'mermaid-chart' }) => {
 ...
 disabled={isCopying}
 className="absolute right-2 top-2 z-10 flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 dark:hover:bg-gray-700 rounded-lg shadow-sm opacity-0 group-hover:opacity-100 transition-all text-xs font-semibold focus:opacity-100 disabled:opacity-100"
 title="Copiar diagrama como imagen PNG"
 >
 {isCopying ? <Check size={14} className="text-green-600 dark:text-green-400" /> : <ImageIcon size={14} />}
