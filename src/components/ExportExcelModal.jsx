...
export default function ExportExcelModal({
 ...
 <div>
 <p className="text-sm font-bold text-gray-900 dark:text-gray-100 ">Exportar con Descripción</p>
 ...
 disabled={loading}
 className="w-full flex items-start gap-3.5 p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 dark:hover:bg-gray-700 transition-all text-left group disabled:opacity-60 disabled:cursor-not-allowed"
 >
 <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-gray-100 dark:bg-gray-800 group-hover:bg-gray-200 transition-colors">
 {loadingType === 'data' && loading
 ? <Loader2 size={18} className="text-gray-600 dark:text-gray-400 animate-spin" />
 : <Download size={18} className="text-gray-600 dark:text-gray-400 " />}
 </div>
 <div>
 <p className="text-sm font-bold text-gray-900 dark:text-gray-100 ">Exportar Solo Datos</p>
 <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 leading-relaxed">
 ...
 <Loader2 size={13} className="animate-spin text-green-600 dark:text-green-400" />
