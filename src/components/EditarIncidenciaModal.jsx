...
export default function EditarIncidenciaModal({ isOpen, onClose, onUpdated, incidencia }) {
 ...
 <div>
 <h2 className="text-lg font-bold text-white">Editar Incidencia</h2>
 <p className="text-xs text-gray-200 dark:text-gray-300">ID: {incidencia.id} — {incidencia.numSerie}</p>
 </div>
 <button
 onClick={onClose}
 className="p-2 text-white hover:bg-[#003824] dark:hover:bg-[#003824] rounded-full transition-colors"
 >
 <X size={20} />
 </button>
 </div>
 ...
 className={`w-full px-3 py-2 text-sm border ${errors.type ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-700 '} rounded-lg focus:ring-2 focus:ring-amber-500 outline-none bg-white dark:bg-gray-800 transition-all`}
 ...
 className={`w-full px-3 py-2 text-sm border ${errors.description ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-700 '} rounded-lg focus:ring-2 focus:ring-amber-500 outline-none resize-none transition-all`}
 />
 ...
 className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none bg-white dark:bg-gray-800 "
 ...
 {/* Requerimiento */}
 <div>
 <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">Requerimiento</label>
 <input
 type="text"
 value={requerimiento}
 ...
 {errors.global && (
 <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 dark:text-red-300 rounded-xl border border-red-100 dark:border-red-800/50 text-xs font-bold animate-pulse">
 {errors.global}
 </div>
 )}
 </form>
