...
function TipoBadge({ tipo }) {
 ...
 return (
 <span className={`px-1.5 py-0.5 rounded text-[10px] font-semibold ${s.bg} ${s.color} ${s.border || ''}`}>{s.label}</span>
 );
}
...
export default function BienAtributosPanel({ id_bien, tipo_disp, readOnly = false, onValuesChange }) {
 ...
 const inputCls = 'w-full px-2.5 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-green-500 outline-none';
 ...
 <tr>
 <th className="px-3 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 w-1/3">Atributo</th>
 <th className="px-3 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 ">Valor</th>
 ...
 return (
 <tr key={item.id_atributo} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 dark:hover:bg-gray-700 transition-colors">
 ...
 <td className="px-3 py-2">
 {readOnly ? (
 <span className="text-gray-700 dark:text-gray-300 ">{item.valor}</span>
 ) : (
 <input
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-green-700 dark:text-green-400 dark:text-green-300 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 text-xs font-semibold transition-colors"
 >
 ...
 {showAdd && !readOnly && (
 <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-3 border border-gray-200 dark:border-gray-700 space-y-2 fade-in">
 <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Agregar Atributo Extra</p>
 <div className="flex gap-2 flex-wrap">
 <div className="relative flex-1 min-w-[160px]">
 <select
 value={selectedAtributo}
 onChange={e => { setSelectedAtributo(e.target.value); setNewValor(''); }}
 className="w-full px-2.5 py-1.5 pr-7 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-green-500 outline-none bg-white dark:bg-gray-800 appearance-none"
 >
 ...
 className="flex-1 min-w-[120px] px-2.5 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-green-500 outline-none disabled:bg-gray-100 dark:disabled:bg-gray-800/50 "
 />
 <button
