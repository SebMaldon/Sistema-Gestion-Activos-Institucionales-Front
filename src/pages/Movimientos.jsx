  ...
  return (
    <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 fade-in h-full flex flex-col">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Generación y registro de salidas de equipo</p>
      </div>
          ...
          <Tabs.List className="flex border-b border-gray-200 mb-6">
            <Tabs.Trigger
              ...
              className={`flex items-center gap-2 px-6 py-3 font-medium text-sm transition-colors relative
                ${activeTab === 'generar' ? 'text-teal-700' : 'text-gray-500 hover:text-gray-700'}
              `}
            >
              <FileText size={16} />
              Generar Salida
            ...
            <Tabs.Trigger
              value="historial"
              className={`flex items-center gap-2 px-6 py-3 font-medium text-sm transition-colors relative
                ${activeTab === 'historial' ? 'text-teal-700' : 'text-gray-500 hover:text-gray-700'}
              `}
            >
              <History size={16} />
