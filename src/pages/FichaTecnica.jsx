...
function InfoRow({ icon: Icon, label, value }) {
 ...
 <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 bg-green-50 dark:bg-green-900/20">
...
export default function FichaTecnica() {
 ...
 <button onClick={closeFicha} className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-colors mt-1">
 <X size={18} />
 </button>
 </div>
