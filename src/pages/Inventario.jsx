...
export default function Inventario() {
 ...
 className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:opacity-90 border border-emerald-300 text-emerald-700 bg-emerald-50 dark:bg-emerald-900/20 hover:bg-emerald-100 shadow-sm"
 >
